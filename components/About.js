      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Xin chào. Tên tôi là Lê Đức Mạnh. Tôi là một lập trình viên Font-End.</p>
        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">manhldph26283@fpt.edu.vn</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">0395888415</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">Chu Phan - Mê Linh - Hà Nội</div>
            </div>
            <div class="row mt-3">
